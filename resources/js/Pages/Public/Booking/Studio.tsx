...
export default function Studio({ studio, sessionTypes }: { studio: StudioRef; sessionTypes: SessionTypeRef[] }) {
    return (
        <div className="min-h-screen bg-neutral-50">
            <Head title={`Book with ${studio.name}`} />
                ...
                {sessionTypes.length === 0 ? (
                    ...
                    <div className="space-y-3">
                        {sessionTypes.map((t) => (
                            <Link
                                key={t.slug}
                                href={route('booking.show', { slug: studio.slug, type: t.slug })}
