...
function renderAnswer(q: Question, value: string | boolean | undefined) {
                ...
                <div className="space-y-3">
                    {questionnaire.questions.map((q) => (
                        <div key={q.key} className="rounded-xl border border-neutral-200 bg-white p-4">
                            ...
                            {completed ? (
                                <p className="mt-1 whitespace-pre-wrap text-sm text-neutral-700">{renderAnswer(q, questionnaire.answers[q.key])}</p>
                            ) : (
