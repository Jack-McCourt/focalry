...
return [
    ...
    */
    ...
    'options' => [
         ...
         */
        // Use a writable app dir, not sys_get_temp_dir(): under php-fpm the system
        // temp dir triggers a tempnam() fallback warning that escalates to a 500.
        'temp_dir' => env('DOMPDF_TEMP_DIR', storage_path('app/dompdf')),
